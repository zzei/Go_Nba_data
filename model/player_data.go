...
type PlayerData struct {
	...
	Hit         float64   `gorm"type:double;column:hit"`
	ThreeShot   string    `gorm"type:varchar(20);column:three_shot"`
	ThreeHit    float64   `gorm"type:double;column:three_hit"`
	PenaltyShot string    `gorm"type:varchar(20);column:penalty_shot"`
	PenaltyHit  float64   `gorm"type:double;column:penalty_hit"`
...
type PlayerDataSerializer struct {
	...
	ThreeHit    float64   `json"three_hit"`
	PenaltyShot string    `json"penalty_shot"`
	PenaltyHit  float64   `json"penalty_hit"`
